...
namespace Wsi.CyFun.Elephants.Web.Controllers
{
    public class AssessmentController : Controller
    {
        ...
        public AssessmentController(ApplicationDbContext applicationDbContext)
        {
            _applicationDbContext = applicationDbContext;
        }
       
        public IActionResult AssessmentOverview()
        {
        ...
        public IActionResult ShowAssessmentForUser(Guid id)
        {
        ...
        [HttpPost]
        public IActionResult SaveAssessmentForUser(AssessmentViewModel model, Guid assessmentId)
        {
            try
            {
                ...
                foreach (var scoreViewModel in model.Scores)
                {
                    ...
                    {
                        if (existingScore.DocumentationMaturityScore != scoreViewModel.DocumentationMaturityScore ||
                            ...
                            existingScore.AdditionalInfo != scoreViewModel.AdditionalInfo)
                        {
                            ...
                            existingScore.ImplementationMaturityScore = scoreViewModel.ImplementationMaturityScore;
                            existingScore.AdditionalInfo = scoreViewModel.AdditionalInfo;
                            assessment.Updated = DateTime.Now;
                        }
                ...
                return RedirectToAction("AssessmentOverview");
            }
            catch (Exception ex)
            {
